...
export default function Head() {
  return (
    <>
      {/* Básico */}
      <title>
        NutriFlow: Seu Nutricionista de Bolso por IA | A partir de R$ 19,90/mês
      </title>
      <meta
        name="description"
      ...
      <meta
        property="og:title"
        content="NutriFlow: Seu Nutricionista de Bolso por IA"
      />
      <meta
      ...
      <meta
        property="og:image"
        content="https://seu-dominio.com.br/og-image.png"
      />
